    ...
    <div class="flex flex-1 px-4 py-6">
        ...
        <div class="w-full mx-4">
            ...
            <div class="text-gray-600 mt-3">
                Lorem ipsum dolor sit amet consectetur. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet
                officia doloribus quibusdam dolorem quod velit repellat obcaecati doloremque, nulla iusto modi hic.
                Dolore possimus consequuntur et recusandae laboriosam? Esse, culpa.
            </div>
    ...
    <div class="flex items-center space-x-4 ml-6">
        <div x-data="{ isOpen: false }" class="relative">
            <button type="button" @click="isOpen = !isOpen"
                class="flex items-center justify-center h-11 w-32 text-sm bg-blue-500 text-white font-semibold rounded-xl border border-blue-500 hover:bg-blue-500 transition duration-150 ease-in px-6 py-3">
                @lang('buttons.reply')
            </button>
            <div class="absolute z-10 w-96 text-left font-semibold text-sm bg-white shadow-xl rounded-xl mt-2" x-cloak
                x-show.transition.origin.top.left="isOpen" @click.away="isOpen = false"
                @keydown.escape.window="isOpen = false">
                <form action="#" class="space-y-4 px-4 py-6">
                    ...
                    <div class="flex items-center space-x-3">
                        <button type="button"
                            class="flex items-center justify-center h-11 w-1/2 text-sm bg-blue-500 text-white font-semibold rounded-xl border border-blue-500 hover:bg-blue-500 transition duration-150 ease-in px-6 py-3">
                            @lang('buttons.postComment')
                        </button>
                        <button type="button"
            ...
            <div x-cloak x-show.transition.origin.top.left="isOpen" @click.away="isOpen = false"
                ...
                <form action="#" class="space-y-4 px-4 py-6">
                    <div class="space-y-2">
                        ...
                        <div>
                            <label class="inline-flex items-center">
                                <input type="radio" class="bg-gray-200 text-purple-600 border-none" name="status"
                                    value="2">
                        ...
                        <div>
                            <label class="inline-flex items-center">
                                <input type="radio" class="bg-gray-200 text-green-600 border-none" name="status"
                                    value="3">
                        ...
                        <div>
                            <label class="inline-flex items-center">
                                <input type="radio" class="bg-gray-200 text-red-600 border-none" name="status"
                                    value="3">
                    ...
                    <div class="flex items-center justify-between space-x-3">
                        ...
                        <button type="submit"
                            class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue-500 text-white font-semibold rounded-xl border border-blue-500 hover:bg-blue-500 transition duration-150 ease-in px-6 py-3">
    ...
    <div class="is-admin comment-container relative bg-white rounded-xl flex mt-4">
        <div class="flex flex-1 px-4 py-6">
            <div class="flex-none">
                ...
                <div class="text-center uppercase text-blue-500 text-xxs font-bold mt-1">Admin</div>
            </div>
            <div class="w-full mx-4">
                <h4 class="text-xl font-semibold">
