    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            ...
            >
                ...
                <div
                    class="absolute z-10 w-96 text-left font-semibold text-sm bg-white shadow-xl rounded-xl mt-2"
                    x-cloak
                    x-show.transition.origin.top.left="isOpen"
                    @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false"
        ...
        <div class="flex items-center space-x-3">
            ...
            <button
                ...
                type="button"
                class="w-32 h-11 text-xs bg-blue-500 font-semibold uppercase rounded-xl border border-blue-500 hover:bg-blue-800 text-white focus:outline-none focus:ring transition duration-150 ease-in px-6 py-3"
            >
                <span>@lang('buttons.voted')</span>
            </button>
            @else
            <button
                wire:click.prevent='vote'
