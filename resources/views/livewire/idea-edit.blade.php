...
>
        <div class="flex items-end justify-center min-h-screen">
            ...
            <div
                x-show.transition.origin.bottom.duration.600ms="isOpen"
            ...
            >
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <p class="text-xs text-center leading-5 text-gray-500 px-6 mt-4">You can only edit 'Open' ideas.</p>

                    <form wire:submit.prevent="editIdea" action="#" method="POST" class="space-y-4 px-4 py-6">
                        <div>
                            <input wire:model.defer="title" type="text" x-ref="title" class="w-full text-sm bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2" placeholder="Your Idea" required>
                            @error('title')
                        ...
                        <div class="flex items-center justify-between space-x-3">
                            ...
                            <button
                                    type="submit"
                                    class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue-600 text-white font-semibold rounded-xl border border-blue hover:bg-blue-900 transition duration-150 ease-in px-6 py-3">
